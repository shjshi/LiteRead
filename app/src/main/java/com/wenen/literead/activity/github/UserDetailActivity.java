...
public class UserDetailActivity extends BaseActivity implements UserDetailContract.View {
  ...
  @Bind(R.id.iv_avatar) CircleImageView ivAvatar;
  @Bind(R.id.tv_bio) AppCompatTextView tvBio;
  @Bind(R.id.tv_name) AppCompatTextView tvName;
  @Bind(R.id.tv_blog) AppCompatTextView tvBlog;
  @Bind(R.id.tb_tab) TabLayout tbTab;
  @Bind(R.id.vp_github) ViewPager vpGithub;
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      if (getIntent().getStringExtra("username") != null) {
        ...
        ImageLoaderConfig.imageLoader.displayImage(githubUser.getGithubLoginModel().avatar_url,
            ivAvatar, ImageLoaderConfig.options, ImageLoaderConfig.animateFirstListener);
  ...
  @Override public void showData(GithubLoginModel githubLoginModel) {
    ...
    assert vpGithub != null;
    tbTab.setupWithViewPager(vpGithub);
    if (vpGithub != null) vpGithub.setAdapter(githubPageAdapter);
  }

  @Override public void refreashData(String username) {
