 ...
 */
public class ZhihuListActivity extends BaseActivity
    implements SwipeRefreshLayout.OnRefreshListener, ZhihuListContract.View {
  @Bind(R.id.toolbar) Toolbar toolbar;
  @Bind(R.id.rcl_zhihu) RecyclerView rclZhihu;
  ...
  @Override public void upDateData(List<ZhihuListModel.StoriesEntity> list) {
    this.list = list;
  }

  @Override public void showData(List<ZhihuListModel.StoriesEntity> list) {
    if (swipeRefreshLayout != null) swipeRefreshLayout.setRefreshing(false);
    if (rclZhihu.getAdapter() != null) zhihuListAdapter.updateList(list);
  }
